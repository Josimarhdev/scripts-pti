...
try:
    dados_path = os.path.join('Inserção','planilha_lacunas','inputs', 'dados.xlsx')
    template_path = os.path.join('Inserção','planilha_lacunas','inputs', 'template.xlsx')
